...
- **Mathematical Differentials:** Explicitly calculates the numerical difference in form, xG trends, pressing intensity, field tilt, offensive expected metrics, rest days, and squad health between the Home and Away teams.
